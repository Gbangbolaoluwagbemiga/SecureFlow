...
export const CONTRACTS = {
  ...
  SECUREFLOW_ESCROW_MAINNET: "0x0000000000000000000000000000000000000000", // Will be updated after deployment
  USDC_MAINNET: "0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913", // USDC on Base

  // Default contracts (used by frontend) - Base Mainnet
  SECUREFLOW_ESCROW: "0x0000000000000000000000000000000000000000", // Will be updated after deployment
