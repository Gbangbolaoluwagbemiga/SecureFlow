...
export default function CreateEscrowPage() {
  ...
  const validateStep = () => {
    if (step === 1) {
      if (!formData.beneficiary || !formData.token || !formData.projectDescription) {
        toast({
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Explain what the freelancer needs to build or deliver. This helps them understand the project
                ...
                >
                  ...
                  <Card className="p-4 bg-accent/10 border-accent/20">
                    <p className="text-sm leading-relaxed">
                      ...
                      <span className="font-bold">{formData.totalAmount} tokens</span> in the smart contract. Funds will
                      be released to the freelancer as milestones are approved.
                    </p>
                  </Card>
                </motion.div>
              )}
            ...
            <div className="flex items-center justify-between mt-8 pt-6 border-t border-border">
              ...
              {step < 3 ? (
                ...
                <Button onClick={handleSubmit} disabled={isSubmitting} className="gap-2 glow-primary">
                  {isSubmitting ? "Creating..." : "Deploy Escrow"}
